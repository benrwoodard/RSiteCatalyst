...
RSiteCatalyst is an R package for accessing the Adobe Analytics API 1.4. The focus of this package are analysts looking for a convenient, programmatic way for accessing their website data using the power of R.

For the new Adobe Analytics API 2.0 features, check out [adobeanalyticsr](https://adobeanalyticsr.com).
...
#### Legacy (WSSE) [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/authentication-1/using-web-service-credentials-2) {.toc-ignore}
...
#### OAuth2 [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/authentication-1/auth-overview-1#concept_4646CEC9CE5E4698A936D84B90A2CD0C) {.toc-ignore}
...
* [GETTING STARTED WITH ADOBE ANALYTICS AND ALTERYX](http://yourlifeindata.com/2018/04/04/getting-started-with-adobe-analytics-and-alteryx/)
...
* [Build Adobe Analytics SDR in R using RSiteCatalyst and Tidyverse (video)](https://www.youtube.com/watch?v=-wUB0aplnik)
...
## **Admin / Metadata Functions** [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/admin-api)
...
#### CancelReport [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-cancel)
...
#### GetActivation [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getactivation-1)
...
#### GetAxleStartDate [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getaxlestartdate)
...
#### GetBaseCurrency [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getbasecurrency-1)
...
#### GetBaseURL [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getbaseurl-1)
...
#### GetBookmarks [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getbookmarks-1)
...
#### GetCalculatedMetrics [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getcalculatedmetrics-1)
...
#### GetClassifications [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getclassifications-1)
...
#### GetClickMapReporting [`r fa("link", fill = "steelblue")`]()
...
#### GetCustomCalendar [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getcustomcalendar-1)
...
#### GetDashboards [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getdashboards-1)
...
#### GetDataWarehouseDisplay [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getdatawarehousedisplay)
...
#### GetDefaultPage [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getdefaultpage-1)
...
#### GetDiscoverEnabled [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getdiscoverenabled)
...
#### GetEcommerce [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getecommerce-1)
...
#### GetElements [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-getelements)
...
#### GetEvars [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getevars-1)
...
#### GetFeed [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/data-feeds/r-getfeed)
...
#### GetFeeds [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/data-feeds/r-getfeeds)
...
#### GetFunctions [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/segments-1-4/calculated-metrics)
...
#### GetGeoSegmentation [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getgeosegmentation)
...
#### GetGroups [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getgroups-1)
...
#### GetInternalURLFilters [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getinternalurlfilters-1)
...
#### GetIPAddressExclusions [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getipaddressexclusions-1)
...
#### GetIPObfuscation [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getipobfuscation-1)
...
#### GetKeyVisitors [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getkeyvisitors-1)
...
#### GetListVariables [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getlistvariables-1)
...
#### GetLocalization [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getlocalization-1)
...
#### GetLogin [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getlogin-1)
...
#### GetMarketingChannelExpiration [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getmarketingchannelexpiration-1)
...
#### GetMarketingChannelRules [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getmarketingchannelrules-1)
...
#### GetMarketingChannels [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getmarketingchannels-1)
...
#### GetMetrics [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-getmetrics)
...
#### GetMobileAppReporting [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getmobileappreporting)
...
#### GetPaidSearchDetection [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getpaidsearchdetection)
...
#### GetPermanentTraffic [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getpermanenttraffic-1)
...
#### GetPreviousServerCalls [`r fa("link", fill = "steelblue")`]()

```{r, cache=cacheflag}
GetPreviousServerCalls(rs$rsid)
```

#### GetPrivacySettings [`r fa("link", fill = "steelblue")`]()

```{r, cache=cacheflag}
GetPrivacySettings(rs$rsid)
```

#### GetProps [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getprops)
...
#### GetQueue [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-getqueue-2)
...
#### GetRealTimeReport [`r fa("link", fill = "steelblue")`]()
...
#### GetRealTimeSettings [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getrealtimesettings)
...
#### GetReportDescription [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getreportdescription)
...
#### GetReportSuiteGroups [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getreportsuitegroups-1)
...
#### GetReportSuites [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getreportsuites-1)
...
#### GetScheduledSpike [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getscheduledspike-1)
...
#### GetSegments [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getsegments-1)
...
#### GetSiteTitle [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getsitetitle-1)
...
#### GetSuccessEvents [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getevents)
...
#### GetTemplate [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-gettemplate-2)
...
#### GetTimeStampEnabled [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-gettimezone-1)

```{r, cache=cacheflag}
GetTimeStampEnabled(c("zwitchdev", "zwitchjulia"))
```

#### GetTimeZone [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-gettimezone-1)
...
#### GetTrackingServer [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-gettrackingserver-1)
...
#### GetTransactionEnabled [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-gettransactionenabled)
...
#### GetUniqueVisitorVariable [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getuniquevisitorvariable-1)
...
#### GetVersionAccess [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getversionaccess)
...
#### GetVideoSettings [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getvideosettings)
...
#### GetVirtualReportSuiteSettings [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-getvirtualreportsuitesettings)
...
#### ViewProcessingRules [`r fa("link", fill = "steelblue")`]()
...
## **Analytics Functions** [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/get-started)
...
#### BuildClassificationValueSegment [`r fa("link", fill = "steelblue")`]()
...
#### GetReport [`r fa("link", fill = "steelblue")`]()

```{r, cache=cacheflag}
#TBD
```

#### GetReportsByIds [`r fa("link", fill = "steelblue")`]()

```{r, cache=cacheflag}
#TBD
```

#### QueueDataWarehouse [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### QueueFallout [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### QueueOvertime [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### QueuePathing [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### QueueRanked [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### QueueSummary [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### QueueTrended [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-reporting-1-4/r-queue)
...
#### SaveRealTimeSettings [`r fa("link", fill = "steelblue")`](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-saverealtimesettings)
